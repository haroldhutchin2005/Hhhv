const num = 15 // Number of times spamming before being banned -1, for example, if 5 times, the 6th will be banned
const timee = 7 // Within the time `timee`, if spamming `num` times, the user will be banned
...
module.exports.handleEvent = async function ({ Users, Threads, api, event})  {
  ...
  if ((global.client.autoban[senderID].timeStart + (timee*1000)) <= Date.now()) {
    ...
    if (global.client.autoban[senderID].number >= num) {
      ...
      api.sendMessage("𝖸𝗈𝗎 𝗁𝖺𝗏𝖾 𝖻𝖾𝖾𝗇 𝖻𝖺𝗇𝗇𝖾𝖽 𝖿𝗋𝗈𝗆 𝗎𝗌𝗂𝗇𝗀 𝗍𝗁𝖾 𝖻𝗈𝗍 𝗂𝗇 𝖺𝖽𝗆𝗂𝗇, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗋𝖾𝗆𝗈𝗏𝖾. 𝖣𝖾𝗉𝖾𝗇𝖽𝗂𝗇𝗀 𝗈𝗇 𝗍𝗁𝖾 𝖼𝖺𝗌𝖾, 𝗂𝗍 𝗐𝗂𝗅𝗅 𝖻𝖾 𝗋𝖾𝗆𝗈𝗏𝖾𝖽 𝖻𝗒 𝖠𝖽𝗆𝗂𝗇𝗂𝗌𝗍𝗋𝖺𝗍𝗈𝗋 𝖡𝗈𝗍\nID: " + senderID + " \nName: " + dataUser.name + `\nReason: spam bot ${num} time/${timee}s\n\n✔Reported to bot admin`, threadID,
    () => {
